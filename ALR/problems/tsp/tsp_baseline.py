...
from ALR.problems.vrp.vrp_baseline import get_lkh_executable
import torch
...
def solve_gurobi(directory, name, loc, disable_cache=False, timeout=None, gap=None):
    ...
    from ALR.problems.tsp.tsp_gurobi import solve_euclidian_tsp as solve_euclidian_tsp_gurobi
...
def solve_all_nn(dataset_path, eval_batch_size=1024, no_cuda=False, dataset_n=None, progress_bar_mininterval=0.1):
    ...
    from ALR.problems import TSP
    from ALR.utils import move_to
