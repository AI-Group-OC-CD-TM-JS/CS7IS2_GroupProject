...
import os
import numpy as np
from ALR.utils import run_all_in_pool
from ALR.utils.data_utils import check_extension, load_dataset, save_dataset
from subprocess import check_call, check_output
import tempfile
import time
from datetime import timedelta
from ALR.problems.op.opga.opevo import run_alg as run_opga_alg
...
def solve_gurobi(directory, name, depot, loc, prize, max_length, disable_cache=False, timeout=None, gap=None):
    ...
    from ALR.problems.op.op_gurobi import solve_euclidian_op as solve_euclidian_op_gurobi
...
def solve_ortools(directory, name, depot, loc, prize, max_length, sec_local_search=0, disable_cache=False):
    ...
    from ALR.problems.op.op_ortools import solve_op_ortools
...
def run_all_tsiligirides(
    ...
    from ALR.utils import move_to, sample_many
    from ALR.problems.op.tsiligirides import op_tsiligirides
    from ALR.problems.op.problem_op import OP
