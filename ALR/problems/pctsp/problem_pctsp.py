...
import os
import pickle
from ALR.problems.pctsp.state_pctsp import StatePCTSP
from ALR.utils.beam_search import beam_search
...
class PCTSP(object):
    ...
    def _get_costs(dataset, pi, stochastic=False):
        if pi.size(-1) == 1:  # In case all tours directly return to depot, prevent further ALR.problems
